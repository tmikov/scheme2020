...
#ifndef S2020_SUPPORT_STRINGTABLE_H
#define S2020_SUPPORT_STRINGTABLE_H
...
template <>
struct DenseMapInfo<s2020::Identifier> {
  static inline s2020::Identifier getEmptyKey() {
    return s2020::Identifier::getFromPointer(
        DenseMapInfo<s2020::UniqueString *>::getEmptyKey());
  }
  static inline s2020::Identifier getTombstoneKey() {
    return s2020::Identifier::getFromPointer(
        DenseMapInfo<s2020::UniqueString *>::getTombstoneKey());
  }
  static inline unsigned getHashValue(s2020::Identifier id) {
    return DenseMapInfo<s2020::UniqueString *>::getHashValue(
        id.getUnderlyingPointer());
  }
  static inline bool isEqual(s2020::Identifier a, s2020::Identifier b) {
    return a == b;
  }
};
...
#endif // S2020_SUPPORT_STRINGTABLE_H
